...
(function(){
  ...
  function initEntertainment(){
    ...
    const game = {running:false,over:false,score:0,best:Number(localStorage.getItem('olon_ent_flappy_best')||0),frame:0,bird:{x:92,y:250,w:72,h:34,r:14,vy:0},pipes:[],clouds:[],groundX:0,gravity:(window.innerWidth<=700?.135:.10),jump:(window.innerWidth<=700?-4.28:-4.05),pipeSpeed:(window.innerWidth<=700?1.42:1.05),pipeGap:(window.innerWidth<=700?180:185),pipeEvery:(window.innerWidth<=700?132:150)};
